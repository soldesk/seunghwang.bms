...
<div id="noticeWriteSection" class="container-fluid">
	<h3 id="freeBoard_title">1:1묻고답하기</h3>
	<div id="freeboard_write">
		<form action="inquiryAnswerProc.jsp?inquiryId=<%=inquiryId %>&userEmail=<%=userEmail %>" method="post">
			<table class="table table-hover">
				<tbody>
					<tr>
						<td>답변 제목</td>
						<td>
							<input type="text" placeholder="답변 제목을 입력하세요." name="answerTitle" required/>
						</td>
					</tr>
				</tbody>
			</table>
			<p>답변 내용</p><textarea name="answerContent" required></textarea>
