...
<%
	...
	NoticeService faqService = new NoticeServiceImpl(noticeDao);
	
	String noticeId = request.getParameter("noticeId");
	String noticeTitle = request.getParameter("noticeTitle");
	String noticeContent = request.getParameter("noticeContent");
	
	if(noticeId==null || noticeTitle==null || noticeContent==null){
		noticeId="";
		noticeTitle="";
		noticeContent="";
	}else{
...
<div id="noticeWriteSection" class="container-fluid">
	...
	<div id="freeboard_write">
		<form action="noticeModProc.jsp?noticeId=<%=noticeId %>" method="post">
			<table class="table table-hover">
							<tbody>
								<tr>
									<td>제목</td>
									<td>
										<input type="text" placeholder="게시글 제목을 입력하세요." name="noticeTitle" value="<%=noticeTitle %>" required/>
									</td>
								</tr>
							</tbody>
								</tbody>
		...
		<textarea name="noticeContent" required><%=noticeContent %></textarea>
