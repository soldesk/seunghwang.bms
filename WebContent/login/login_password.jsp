...
<head>
  ...
  <style>/*hotpink*/
	...
	.user-modify{margin-left: 310px; margin-top: 20px; width: 150px;}
...
.tab_bgcolor{background-color: hotpink;}
#table_size{margin-left: 80px; width: 380px; font-weight: bold; color: white; font-size: 15px;}
  </style>
</head>
<body>
<div id="userInfoSection" class="container-fluid">
	<h3 id="freeBoard_title">비밀번호 변경</h3>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a class="list-group-item category_accordion_button" data-toggle="collapse" data-parent="#accordion" href="#c1">비밀번호 변경</a>
        </h4>
      </div>
	...
	<form action="loginModifyPwAction.login" method="post" >
		<div id="user_info_body">
		<table class="table table-hover" id="table_size">
			<tbody>
				<tr align="center">
					<td class="tab_bgcolor" >비밀번호</td>
				</tr>
				<tr align="center">
					<td><input type="password" required name="userPw"/></td>
				</tr>
				<tr align="center">
					<td class="tab_bgcolor"  >비밀번호 재입력</td>
				</tr>
				<tr align="center">
					<td><input type="password"  required  name="userPw2"/></td>
				</tr>
				
			</tbody>
		</table>
		</div>
		<input type="submit" class="btn btn-default user-modify" value="수정완료 ">
		</form>
</div>
</body>
</html>