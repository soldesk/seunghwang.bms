...
<head>
  ...
  <style>/*hotpink*/
	...
	#thumbnail_title{margin-left: 340px; filter: drop-shadow(1px 1px 1px rgba(0, 0, 0, .3));	width: 150px; height: 30px; padding-left: 27px; padding-top: 5px;
	color: white;
...
<div id="literatureBooklist" class="container-fluid">
	<h3 id="thumbnail_title">문학 추천책</h3>
