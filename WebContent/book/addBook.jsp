...
<div id="bookInfoSection" class="container-fluid">
	<h3 id="freeBoard_title">도서 추가</h3>
      ...
      <div id="c1" class="panel-collapse collapse">
		...
		<div id="book_info_body">
			...
			<tbody>
				...
				<tr>
					<td>평점</td>
					<td><input type="text" name="bookGrade"/></td>
					<td>베스트셀러</td>
					<td>
				...
				<tr>
					<td>기타정보</td>
					<td colspan="4"><textarea name="bookETC"></textarea></td>
					<td>기타정보에는 "책 크기: 00 x 00cm // 총 페이지 000쪽 // 양장본 or 양장아님" 형식으로 정보를 등록해주세요.</td>
				</tr>
				<tr>
					<td>책 소개</td>
					<td colspan="4"><textarea name="detailBook"></textarea></td>
				...
				<tr>
					<td>출판사 서평</td>
					<td colspan="4"><textarea name="detailReview"></textarea></td>
				</tr>
				<tr>
					<td>저자 소개</td>
					<td colspan="4"><textarea name="detailWriter"></textarea></td>
				</tr>
				<tr>
					<td>목차</td>
					<td colspan="4"><textarea name="detailChapter"></textarea></td>
				</tr>
			</tbody>
		</table>
		<input type="submit" class="btn btn-default btn-pos" value="추가완료"/>
